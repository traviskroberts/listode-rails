module ApplicationHelper
  ...
  def draw_graph(task)
    lists = List.where("lists.complete = ? AND lists.amount IS NOT NULL AND lists.task_id = ?", true, task.id).includes(:month_list).order('month_lists.year, month_lists.month')
